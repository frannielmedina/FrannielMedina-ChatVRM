  ...
  return (
    <div className="absolute right-0 z-10 m-24">
      <a
        ...
        target="_blank"
      >
        <div className="p-8 rounded-16 bg-[#1F2328] hover:bg-[#33383E] active:bg-[565A60] flex transition-all hover:scale-105">
          <img
            alt="https://github.com/frannielmedina/frannielmedina-chatvrm"
            height={24}
            width={24}
