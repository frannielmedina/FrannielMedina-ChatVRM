...
export const SettingsTabs = (props: Props) => {
  ...
  return (
    <div 
      className={`absolute z-40 w-full h-full bg-white/80 backdrop-blur transition-all duration-300 ${
          ...
          <div className="flex flex-wrap gap-2 mb-8 border-b-2 border-gray-200 pb-4">
            {tabs.map(tab => (
              <button
                ...
                className={`px-4 py-2 rounded-t-lg font-semibold transition-all duration-300 transform ${
                  activeTab === tab.id
